...
source = "Data/3D tracking data to visualize/20190701--2_inter_29layers_mask_3a" # folder containing original files
target_folder = "Data/20190701--2_inter_29layers_mask_imagej" # folder to save converted files
