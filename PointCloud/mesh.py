...
# data = tifffile.imread('Data/3D tracking data to visualize/20190701--2_inter_29layers_mask_3a/20190701--20000_M3a_Step92.tif') #29 layers 16bit
data = tifffile.imread('Data/20190701--20000_M3a_Step92.tif') #29 layers 16bit converted to 16bit

# data = tifffile.imread('Data/20190701--20000_M3a_Step92_8bit.tif') #29 layers 8bit
